<x-layout.app :title="'Encerradas pelo robô - MGI chat'" :fullWidth="true">
    ...
    <div x-data="botConversationsApp()" x-init="init()" class="flex h-[calc(100vh-4rem)] overflow-hidden lg:h-[calc(100vh-5rem)]">
        ...
        <div :class="mobileView === 'chat' ? 'hidden lg:flex' : 'flex'"
            ...
            <div class="border-b border-slate-200 bg-white p-4">
                <div class="mb-3 flex items-start justify-between gap-3">
                    <div>
                        <p class="font-display text-lg font-semibold text-[#5C1529]">Arquivo do bot</p>
                ...
                <template x-for="conv in conversations" :key="conv.id">
                    <button type="button" @click="openDetails(conv)"
                        ...
                        <div class="relative shrink-0">
                            ...
                            <span class="absolute -bottom-0.5 -right-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-white text-[10px] shadow-sm ring-1 ring-slate-200">🤖</span>
                        </div>
        ...
        <div :class="mobileView !== 'chat' ? 'hidden lg:flex' : 'flex'" class="relative flex flex-1 flex-col bg-white">
            ...
            <div class="custom-scrollbar flex-1 space-y-3 overflow-y-auto p-4 sm:p-5">
                <div x-show="!selected && !loading" class="flex h-full min-h-[16rem] flex-col items-center justify-center text-center">
                    ...
                    <p class="font-display text-xl font-semibold text-[#5C1529]">Arquivo do robô</p>
